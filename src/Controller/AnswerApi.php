 ...
 * 回答
 */
class AnswerApi extends Abstracts
{
    /**
     * 获取回答列表
     *
    ...
    {
        return $this->answerService->getList();
    }
    ...
    {
        return $this->answerService->getOrFail($answer_id);
    }
    ...
    public function update(int $answer_id): array
    {
        ...
        return $this->answerService->get($answer_id);
    }
    ...
    {
        return $this->answerService->getDeleted();
    }
    ...
    public function restoreMultiple(): array
    {
        ...
        $this->answerService->restoreMultiple($answerIds);
    ...
    public function destroyMultiple(): array
    {
        ...
        $this->answerService->destroyMultiple($answerIds);
    ...
    {
        $this->answerService->restore($answer_id);
    ...
    {
        $this->answerService->destroy($answer_id);
