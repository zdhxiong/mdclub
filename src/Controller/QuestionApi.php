 ...
 * 提问 restful api
 */
class QuestionApi extends Abstracts
{
    /**
     * 获取提问列表
     *
    ...
    {
        return $this->questionService->getOrFail($question_id);
    }
    ...
    public function update(int $question_id): array
    {
        ...
        return $this->questionService->get($question_id);
    }
    ...
    {
        return $this->answerService->getByQuestionId($question_id);
    }
    ...
    public function createAnswer(int $question_id): array
    {
        ...
        return $this->answerService->get($answerId);
    }
    ...
    {
        return $this->questionService->getDeleted();
    }
    ...
    public function restoreMultiple(): array
    {
        ...
        $this->questionService->restoreMultiple($questionIds);
    ...
    public function destroyMultiple(): array
    {
        ...
        $this->questionService->destroyMultiple($questionIds);
    ...
    {
        $this->questionService->restore($question_id);
    ...
    {
        $this->questionService->destroy($question_id);
