 ...
 * 文章 restful api
 */
class ArticleApi extends Abstracts
{
    /**
     * 获取文章列表
     *
    ...
    {
        return $this->articleService->getOrFail($article_id);
    }
    ...
    public function restoreMultiple(): array
    {
        ...
        $this->articleService->restoreMultiple($articleIds);
    ...
    public function destroyMultiple(): array
    {
        ...
        $this->articleService->destroyMultiple($articleIds);
    ...
    {
        $this->articleService->restore($article_id);
    ...
    {
        $this->articleService->destroy($article_id);
