...
$modules = [
    ...
    \App\Service\AnswerVoteService::class,
    \App\Service\ArticleCommentService::class,
    \App\Service\ArticleFollowService::class,
    \App\Service\ArticleService::class,
    \App\Service\ArticleVoteService::class,
    \App\Service\CaptchaService::class,
    \App\Service\CommentService::class,
    \App\Service\CommentVoteService::class,
    ...
    \App\Service\QuestionVoteService::class,
