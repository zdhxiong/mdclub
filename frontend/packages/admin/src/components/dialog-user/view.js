...
export default () => (global_state, global_actions) => {
  const actions = global_actions.components.dialogUser;
  const state = global_state.components.dialogUser;
      ...
      <If condition={!state.loading && state.user}>
        ...
        <div class="body">
          <div class="mdui-row">
            <div class="actions">
              <button
                class="mdui-fab mdui-color-blue-accent"
                mdui-tooltip="{content: '编辑账户信息', delay: 300}"
              >
                <i class="mdui-icon material-icons">edit</i>
              </button>
              <button
                class="mdui-fab mdui-color-pink-accent"
